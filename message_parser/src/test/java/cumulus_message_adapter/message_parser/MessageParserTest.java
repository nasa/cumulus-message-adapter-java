...
public class MessageParserTest {
    ...
    public void testMessageAdapter() {
        ...
        try {
            ...
            Map<String, Object> taskOutputJson = AdapterUtilities.convertJsonStringToMap(taskOutputString);
    ...
    public void testLoadAndUpdateRemoteEvent() {
        ...
        try {
            ...
            Map<String, Object> expectedOutputJson = AdapterUtilities.convertJsonStringToMap(expectedJsonString);
